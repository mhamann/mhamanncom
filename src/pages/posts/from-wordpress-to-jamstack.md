...
JAMstack is still in the early adopter phase to some degree. There are some great frameworks out there for building static sites (Gatsby, Hugo, and Jekyll to name a few popular ones), but the tools surrounding them are still pretty rough. The authoring and site management experience pales greatly in comparison to WordPress, and there are a lot fewer "batteries included" options (e.g. form handling).
